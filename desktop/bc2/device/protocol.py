...
CMD_PING=0x01; CMD_GET_INFO=0x02; CMD_GET_STATE=0x03; CMD_GET_CAPABILITIES=0x04; CMD_GET_WALLET_STATUS=0x40; CMD_BEGIN_CREATE_WALLET=0x41; CMD_BEGIN_RECEIVE_ADDRESS=0x42; CMD_GET_RECEIVE_RESULT=0x43; CMD_BEGIN_RECOVERY=0x44; CMD_BEGIN_UNLOCK=0x45; CMD_SUBMIT_RECOVERY_MNEMONIC=0x46; CMD_LOCK_WALLET=0x47; CMD_GET_WALLET_ID=0x48; CMD_REVIEW_TRANSACTION=0x21; CMD_GET_TRANSACTION_RESULT=0x22; CMD_SIGN_TRANSACTION=0x23; CMD_GET_SIGN_RESULT=0x24
