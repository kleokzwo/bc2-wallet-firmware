...
bc2_hal_result_t bc2_device_ui_render(const bc2_hal_t *hal, bc2_device_screen_t screen,
    ...
    switch (screen) {
        case BC2_DEVICE_SCREEN_BOOT:
            ...
            copy_text(frame.body, sizeof(frame.body),
                      primary_text != NULL && primary_text[0] != '\0'
                          ? primary_text : "Starte sicheren Wallet-Core");
        ...
        case BC2_DEVICE_SCREEN_LOCKED:
            ...
            copy_text(frame.body, sizeof(frame.body), "USB VERBUNDEN  V0.33.0");
